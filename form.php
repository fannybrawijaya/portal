...
<table  width="400" style="background-color:#eee;"  border='5'>
	...
	<tr>
		<td> Nomor Surat </td> <td> <input type="text" name="nomor_surat"><br> </td>
	...
	<tr>
		<td> Tgl_KRS </td> <td> <input type="text" name="tglkrs"><br> </td>
	</tr>
	...
	<tr>
		...
		<td> Tanggal Kontrol </td> <td> <input type="text" name="tgl_ktrl"><br> </td>
	</tr>

	<tr>

		<td>NUMERIK/SPRI (WAJIB 6 DIGIT)</td> <td> <input type="text" name="spri"><br> </td>
	</tr>


	<tr>

		<td>Keterangan</td> <td> <input type="text" name="keterangan"><br> </td>
	</tr>
