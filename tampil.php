...
<div class="content">
	<header>
		<center> <h3 class="deskripsi"> <font face="verdana" color="#FFFFF0" >SURAT KONTROL</h3> </center>
	</header>
...
<form action="" method="POST">
    ...
    <input type="submit" name="cari" class="active4" value="CARI" />
</form>

<form>
<input class="active4" type="button" value="Export Ke Excel" onclick="window.location.href='http://localhost/portal/export'" />
</form>
...
<?php
	...
	if(isset($_POST['query'])){
		$query=$_POST['query'];
		$sql=$conn->query("select * from pasien where norm LIKE '%".$query."%' OR nama LIKE '%".$query."%' OR spri LIKE '%".$query."%' OR kode LIKE '%".$query."%' order by spri desc");
