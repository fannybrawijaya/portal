...
<body >
		...
		?>
          ...
          <div align="center" class="kontainer" style="color:white; text-shadow: 2px 2px 4px #000000;">Sistem Antrian Pasien</div>
      
        <div class="kontainer">
          <div align="center"><a id="konter" href="index.php" ><?php echo $antrian; ?></a></div>
        </div>
