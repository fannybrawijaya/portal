...
<ul>
  ...
  <li><a href="https://sisrute.kemkes.go.id/baru/index.php"> SISRUTE</a></li>
	...
	<header>
		<header>
		<center> <h3 class="deskripsi">  <font face="verdana" > Form Arsip Data Kepegawaian Digital RSIA FATIMAH </font> </h3> </center>
	</header>
	</header>
...
<?php
	$sql=$conn->query ("select * from kepegawaian");
...
?>
	...
	<tr> 
		...
		<td><a href="lihat.php?id=<?php echo $rs->id; ?>">Lihat</a></td>
